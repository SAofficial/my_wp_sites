		...
		<div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 1.4s ease 0s; width: 2490px;">
			...
			if ( $the_query->have_posts() ) {
		            while ( $the_query->have_posts() ) {
							...
							$star     = get_post_meta( $post_id, 'ratingValue', true );
							
							$Username_reviewed = get_post_meta( $post_id, 'user_name', true );
							...
							<div class="img-with-aniamtion-wrap " data-max-width="100%" data-border-radius="none"><div class="inner">
								<img data-shadow="none" data-shadow-direction="middle" class="img-with-animation skip-lazy  animated-in" data-delay="0" height="" width="366" data-animation="fade-in" src="<?= $img_url; ?>" srcset="<?= $img_url; ?> 366w, <?= $img_url; ?> 222w" sizes="100vw" alt="" style="opacity: 1;">
					...
					<div class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_fadeInUp fadeInUp animated wpb_start_animation">
						<div class="wpb_wrapper">
							<h3 style="text-align: center;"><?= $Username_reviewed; ?></h3>
